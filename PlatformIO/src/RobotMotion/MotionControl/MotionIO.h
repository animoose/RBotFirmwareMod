...
private:
    ...
    // In this version, we support only one shield, and this limits us to two steppers.
    // To add more, this could be replaced by multiple shields at different addresses.
    // Allocated dynamically when we need it.
    Adafruit_MotorShield *_adafruit_shield;
